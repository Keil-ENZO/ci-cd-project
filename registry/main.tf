...
resource "aws_security_group" "registry_sg" {
  # name_prefix au lieu de name : AWS ajoute un suffixe aléatoire unique.
  # Évite la collision avec un SG portant déjà ce nom dans le VPC.
  name_prefix = "registry-sg-enzo"
